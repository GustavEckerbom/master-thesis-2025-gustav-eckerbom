...
ARM_DRIVER_GPIO *BOARD_USER_BUTTON_GPIO_GPIOdrv = &ARM_Driver_GPIO_(BOARD_USER_PUSH_GPIO_PORT);
...
int main(void)
{
    ...
    // ret = config_run_power_domain_without_PD6();
