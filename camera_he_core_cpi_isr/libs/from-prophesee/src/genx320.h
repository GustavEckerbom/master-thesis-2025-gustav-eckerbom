...
extern uint32_t deadtime_between_frames; // 875us at deafult
...
extern const BIAS_Params_t quiet_biases;
...
extern void psee_sensor_set_deadtime(uint32_t deadtime);
