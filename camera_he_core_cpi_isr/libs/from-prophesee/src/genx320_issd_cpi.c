...
static const struct reg_op dcmi_init_seq[] = {
	...
	// {.op = WRITE, .args = {.write = {0x020CUL, 0x00000029}} },   // rtc_clk_div = 20, rtc_clk_en = 1

	
	{.op = WRITE, .args = {.write = {0x0204UL, 0x00004D6C}} },	 // saphir/sys_clk_ctrl                     Write fields: sys_clk_auto_mode
	// {.op = WRITE, .args = {.write = {0x0204UL, 0x00009A6C}} }, // sys_clk_ctrl for 20MHz CPI input, same internal speed as at 10MHz
	...
	//{.op = WRITE, .args = {.write = {0x800CUL, 0x00020814}} },
