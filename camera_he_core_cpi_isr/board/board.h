...
#define BOARD_IS_CUSTOM_VARIANT
#include "ncs_custom_board_rev1/board_defs.h"
#endif


#if defined(BOARD_IS_CUSTOM_VARIANT)
#define BOARD_UART_INSTANCE         1 // UART1 available on pinheader change to UART 2 if devkit gen 2
#define BOARD_CAM_I2C_INSTANCE      0

#elif defined(BOARD_IS_ALIF_DEVKIT_B0_VARIANT)
#define BOARD_UART_INSTANCE = 2; // UART2 available on USB port of devikit gen 2 board
...
void BOARD_Pinmux_Deinit_PD6_Off();
