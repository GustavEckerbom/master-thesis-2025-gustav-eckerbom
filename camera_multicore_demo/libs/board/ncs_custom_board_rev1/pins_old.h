...
const struct pinconf board_pinconf[] = {
	...
	{PORT_2, PIN_5, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_SLEW_RATE_FAST | PADCTRL_DRIVER_DISABLED_PULL_DOWN | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	// THIS WAS GENERATED BY THE CONDUCTOR TOOL {PORT_6, PIN_7, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_SLEW_RATE_FAST | PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA},
	...
	{PORT_7, PIN_3, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_SLEW_RATE_FAST | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* P7_5 on pin U2 {FLEX IO}. Functions: [0]: >>>GPIOV_2<<<, [1]: LPTMR2_CLK_IO. Note that LPGPIO_CTRL_n register has a different layout! */
	/* Selected: GPIOV_2 for "CAM_PXRSTN" */
	...
	/* Selected: GPIOV_3 for "CAM_ULP_TH" */
	{PORT_7, PIN_7, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA | PADCTRL_DRIVER_OPEN_DRAIN},	
	...
	{PORT_12, PIN_5, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: GPIO15_3 for "CAM_ULP_WAKEUP" */
	{PORT_15, PIN_3, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_READ_ENABLE | PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
