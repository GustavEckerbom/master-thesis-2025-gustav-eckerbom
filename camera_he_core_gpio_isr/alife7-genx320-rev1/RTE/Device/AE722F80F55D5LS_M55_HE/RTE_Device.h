...
#endif
// </e> MT9M114 [Driver_MT9M114]
// <e> GENX320 [Driver_GENX320]
// <i> Enable/Disable GenX320 camera sensor
// Note; This is just a boiler plate code atm, need to be reviewed to properly configure the LPCPI to match the sensor
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_ENABLE                1

#if (RTE_GENX320_CAMERA_SENSOR_LPCPI_ENABLE)
#define RTE_Drivers_CAMERA_SENSOR_GENX320                     1

// <o> Select GenX320 pixel clock polarity
//     <0=> not invert camera pixclk
//     <1=> invert camera pixclk
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_PIXEL_CLK_POL         1 // Confirmed with oscilloscope

// <o> Select GenX320 HSYNC polarity
//     <0=> not invert HSYNC input
//     <1=> invert HSYNC input
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_HSYNC_POL             1 // Confirmed with oscilloscope

// <o> Select GenX320 VSYNC polarity
//     <0=> not invert VSYNC input
//     <1=> invert VSYNC input
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_VSYNC_POL             1 // Confirmed with oscilloscope

// <o> Select GenX320 VSYNC wait
//     <0=> vsync wait disable
//     <1=> vsync wait enable
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_VSYNC_WAIT            1 // Confirmed!

// <o> Select GenX320 VSYNC mode
//     <0=> sync enable
//     <1=> data enable
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_VSYNC_MODE            0 // Kind of confirmed, according to psee sensor both the HSYNC and VSYNC are low when data is valid, with inverted polarity setting they are high when data is valid.
...
//     <2=> 4 bit
//     <3=> 8 bit
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_DATA_MODE             3 // Confirmed!

// <o> Select Data Endianness
//     <0=> LSB First
//     <1=> MSB First
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_DATA_ENDIANNESS       0 // Testing 

// <o> Select CODE10ON8
//     <0=> Disable
//     <1=> Enable
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_CODE10ON8             0 // Confirmed!

// <o> GenX320 frame height
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_FRAME_HEIGHT          64   // Confirmed!

// <o> GenX320 frame width
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_FRAME_WIDTH           1024 // Confirmed! 

// <o> I2C instance used by GenX320
//     <0=>   I2C0
//     <1=>   I2C1
//     <2=>   I2C2
//     <3=>   I2C3
//     <4=>   I2C OVER I3C
#define RTE_GENX320_CAMERA_SENSOR_LPCPI_I2C_INSTANCE          1

#define RTE_GENX320_CAMERA_SENSOR_CLK_SCR_DIV                 16 // 10MHz clock for GenX320
...
// <i> default: enable
#define RTE_ARX3A0_CAMERA_SENSOR_CSI_ENABLE             0
